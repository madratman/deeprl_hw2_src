...
srun nvidia-docker run --rm -e CUDA_VISIBLE_DEVICES=`echo $CUDA_VISIBLE_DEVICES` -v /data/datasets:/data/datasets -v /home/$USER:/home/$USER vdugar/deep_learning /bin/bash -c "cd /home/ratneshm/courses/deeprl_hw2_src; python dqn_atari.py --env='enduro'"
